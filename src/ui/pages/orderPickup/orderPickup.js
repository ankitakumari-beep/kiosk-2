...
// function isVisibleByFilter(order) {
...
//   let row = rowMap.get(order.orderId);

//   if (!isVisibleByFilter(order)) {
//     if (row) {
//       row.remove();
//       rowMap.delete(order.orderId);
//     }
//     updateEmptyState();
//     return;
//   }
...
//       const row = rowMap.get(order.orderId);
//       if (row) {
//         row.remove();
//         rowMap.delete(order.orderId);
//         updateEmptyState();
...
//     ordersMap.forEach(order => renderOrder(order));
//   };
// });
